    ...
    return (
        <div className="p-8 flex flex-col items-center min-h-screen bg-black">
            <div className="w-full sm:w-3/4 lg:w-[67%] max-w-md">
                ...
                <div className="mb-4">
                    <h1 className="text-white text-2xl font-bold">Use an existing wallet</h1>
                    <p className="text-white py-5">Select how you&apos;d like to access your existing wallet</p>
                </div>
                        ...
                        <Link to={tab.link} key={index} className="block p-5 outline outline-1 outline-gray-500 rounded-lg">
                            <div className="flex justify-center justify-items-center" >
                                <div className="flex-1 w-90">
                                    <h2 className="text-white text-lg font-semibold">{tab.name}</h2>
                ...
                <div className="mt-8 text-center">
                    <p className="text-white text-2 font-bold">Link Coinbase Wallet mobile app</p>
                </div>
            </div>
        </div>
    );
